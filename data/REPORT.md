...
_Mis à jour le 23/09/2026 à 17:41 (Europe/Paris)._

## Vue d'ensemble

- Trades clôturés : **56**
- Taux de réussite cumulé (TP / (TP+SL)) : **44%** — hasard attendu 41%, avantage **+3%**
- P&L théorique cumulé, net des coûts estimés (somme des % par trade, sans levier) : **-3.02 %** (brut -1.00 %)
- Signaux ouverts : **2**
- Signaux fantômes (suivis en silence pour l'apprentissage) : **37** clôturés, 1 ouverts, taux de réussite 50% (hasard attendu 41%)

## Signaux ouverts

| Heure | Actif | Sens | Entrée | TP | SL | Confiance | Source | Expire |
|---|---|---|---:|---:|---:|---|---|---|
| 23/09 17:25 | Nasdaq 100 (NQ) | short | 30794.5 | 30760.25 | 30822.5 | fort | signaux du bot | 18:25 |
| 23/09 17:25 | S&P 500 (ES) | short | 7792.25 | 7782.75 | 7798.5 | fort | signaux du bot | 18:25 |
...
| short | 18 | 8 | 8 | 2 | 50% | -0.010 % |

### Par confiance

| Segment | Trades | TP | SL | Expirés | Taux de réussite | P&L moyen |
|---|---:|---:|---:|---:|---:|---:|
| fort | 52 | 19 | 23 | 10 | 45% | -0.052 % |
...
| Segment | Trades | TP | SL | Expirés | Taux de réussite | P&L moyen |
|---|---:|---:|---:|---:|---:|---:|
| adx | 55 | 20 | 25 | 10 | 44% | -0.052 % |
| corr | 10 | 2 | 5 | 3 | 29% | -0.113 % |
| level | 5 | 1 | 4 | 0 | 20% | -0.133 % |
| macd | 12 | 5 | 7 | 0 | 42% | -0.118 % |
| orb | 4 | 1 | 3 | 0 | 25% | -0.087 % |
| pdhl | 8 | 2 | 6 | 0 | 25% | -0.128 % |
| rsi | 46 | 17 | 19 | 10 | 47% | -0.044 % |
| trend_15m | 55 | 20 | 25 | 10 | 44% | -0.052 % |
| trend_1h | 55 | 20 | 25 | 10 | 44% | -0.052 % |
| trend_5m | 49 | 19 | 20 | 10 | 49% | -0.039 % |
| volume | 2 | 1 | 1 | 0 | 50% | -0.043 % |
| vwap | 53 | 20 | 23 | 10 | 47% | -0.042 % |
...
| actualité chargée | 32 | 12 | 13 | 7 | 48% | -0.037 % |
...
| signaux du bot | 55 | 20 | 25 | 10 | 44% | -0.052 % |

### Par horizon

| Segment | Trades | TP | SL | Expirés | Taux de réussite | P&L moyen |
|---|---:|---:|---:|---:|---:|---:|
| 1h | 54 | 20 | 23 | 11 | 47% | -0.046 % |
| 3h | 2 | 0 | 2 | 0 | 0% | -0.280 % |
...
| Segment | Trades | TP | SL | Expirés | Taux de réussite | P&L moyen |
|---|---:|---:|---:|---:|---:|---:|
| adx | 37 | 15 | 15 | 7 | 50% | -0.024 % |
| corr | 6 | 0 | 4 | 2 | 0% | -0.276 % |
| level | 4 | 2 | 1 | 1 | 67% | -0.017 % |
| macd | 5 | 1 | 3 | 1 | 25% | -0.098 % |
| orb | 2 | 2 | 0 | 0 | 100% | +0.112 % |
| pdhl | 1 | 0 | 1 | 0 | 0% | -0.095 % |
| rsi | 12 | 7 | 4 | 1 | 64% | +0.125 % |
| trend_15m | 37 | 15 | 15 | 7 | 50% | -0.024 % |
| trend_1h | 35 | 13 | 15 | 7 | 46% | -0.031 % |
| trend_5m | 22 | 12 | 9 | 1 | 57% | +0.035 % |
| vwap | 36 | 15 | 14 | 7 | 52% | -0.011 % |
...
| ethereum | 8 | 1 | 5 | 2 | 17% | -0.217 % |
| gold | 6 | 3 | 3 | 0 | 50% | +0.051 % |
| nasdaq | 13 | 8 | 4 | 1 | 67% | +0.056 % |
| oil | 3 | 1 | 2 | 0 | 33% | -0.114 % |
...
| reprise juste après un stop | 2 | +1.27 R | en test |
| nouvel actif : Ethereum (ETH/USD) | 2 | +0.01 R | en test |
| nouvel actif : Pétrole WTI (CL) | 3 | -0.24 R | en test |
| nouvel actif : Euro / dollar (6E) | 0 | n/a | en test |

Notes :

- trades réels : +0,06 R ± 0,30 R par trade avant frais sur 56 trades (0 R = hasard)
- aucun critère ne s'écarte du hasard au-delà de la marge de sécurité : poids par défaut conservés
- oil, vwap : -0,14 R contre +0,07 R en global sur 117 trades éq. → poids ×0,99 sur cet actif
...
- variante « reprise juste après un stop » en test : 2 trades, +1,27 R net, encore 98 trades avant décision
- variante « nouvel actif : Ethereum (ETH/USD) » en test : 2 trades, +0,01 R net, encore 98 trades avant décision
- variante « nouvel actif : Pétrole WTI (CL) » en test : 3 trades, -0,24 R net, encore 97 trades avant décision
