...
def halal_config(path: Path | None = None) -> Config:
    ...
    cfg.range_min_fill = 0.1                # … et séance de 8 h 30 : une tranche de 12 h n'est jamais pleine
    ...
    cfg.pre_open_minutes = 0                # trades de ~12 h : le pic de l'ouverture américaine ne les concerne pas
    cfg.pre_open_after_minutes = 0
